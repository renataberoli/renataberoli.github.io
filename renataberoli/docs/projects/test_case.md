...
### test_repository_search_by_size
| Description | Test Data | Expected Result | 
| ----------- | --------- | --------------- | 
...
### test_repository_search_by_number_of_followers 
| Description | Test Data | Expected Result | 
| ----------- | --------- | --------------- | 
...
| **Comments:** This test was hard to do due to the confusion about the subject of the repository's "follower". [Problem evidence](https://github.community/t/api-is-very-confusing-by-listing-stars-count-for-watchers-count-on-all-repos/13817) |

----

### test_repository_search_by_number_of_forks 
| Description | Test Data | Expected Result | 
| ----------- | --------- | --------------- | 
...
**Comments:** I found an ordination issue repository's response when the number of cores is lower (like in the >=1000 scenario). To see more about this problem, consider visiting the [test code in my Github repository](https://github.com/renataberoli/Unittest_Python). 

----

### test_repository_search_by_number_of_stars 
| Description | Test Data | Expected Result | 
| ----------- | --------- | --------------- | 
...
### test_repository_search_by_creation_date 
| Description | Test Data | Expected Result | 
| ----------- | --------- | --------------- | 
...
### test_repository_search_by_push_date
| Description | Test Data | Expected Result | 
| ----------- | --------- | --------------- | 
...
### test_repository_search_by_language
| Description | Test Data | Expected Result | 
| ----------- | --------- | --------------- | 
...
### test_repository_search_by_topic
| Description | Test Data | Expected Result | 
| ----------- | --------- | --------------- | 
...
### test_repository_search_by_number_of_topics
| Description | Test Data | Expected Result | 
| ----------- | --------- | --------------- | 
...
### test_repository_search_by_license
| Description | Test Data | Expected Result | 
| ----------- | --------- | --------------- | 
...
### test_repository_search_by_visibility
| Description | Test Data | Expected Result | 
| ----------- | --------- | --------------- | 
...
### test_repository_search_by_if_is_mirror
| Description | Test Data | Expected Result | 
| ----------- | --------- | --------------- | 
...
### test_repository_search_by_if_is_archived
| Description | Test Data | Expected Result | 
| ----------- | --------- | --------------- | 
...
### test_repository_search_by_issue_label_good_first_issues
| Description | Test Data | Expected Result | 
| ----------- | --------- | --------------- | 
...
### test_repository_search_by_issue_label_wanted_issues
| Description | Test Data | Expected Result | 
| ----------- | --------- | --------------- | 
...
### test_repository_search_by_ability_to_sponsor
| Description | Test Data | Expected Result | 
| ----------- | --------- | --------------- | 
...
**Comments:** The API didn't return an object that helped to confirm this test.
